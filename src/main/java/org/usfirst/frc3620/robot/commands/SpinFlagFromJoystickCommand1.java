 ...
 *
 */
public class SpinFlagFromJoystickCommand1 extends Command {
	Logger logger = EventLogging.getLogger(getClass(), Level.INFO);
	
    public SpinFlagFromJoystickCommand1() {
    ...
    protected void execute() {
        double joystickposition = Robot.oi.getRequestedFlagSpeed() - Robot.oi.getRequestedFlagSpeedOpposite();
